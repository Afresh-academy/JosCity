        ...
        <div className="legal-container">
          ...
          <div className="legal-content">
            ...
            <section className="legal-section">
              ...
              <p>
                JosCity Smart Services uses cookies and similar tracking technologies to enhance your experience on our platform. We use cookies for the following purposes:
              </p>
              ...
              <ul>
                <li><strong>Session Management:</strong> To maintain your login session</li>
              ...
              <ul>
                <li><strong>Preferences:</strong> To remember your language and region settings</li>
              ...
              <ul>
                ...
                <li><strong>User Behavior:</strong> To improve user experience and functionality</li>
              </ul>
              ...
              <ul>
                <li><strong>Ad Targeting:</strong> To show you relevant content</li>
                <li><strong>Campaign Tracking:</strong> To measure the effectiveness of our communications</li>
              </ul>
            </section>
            ...
            <section className="legal-section">
              ...
              <p>
                You can manage your cookie preferences through our Platform settings. Access your account settings to customize which types of cookies you accept.
              </p>
            </section>
