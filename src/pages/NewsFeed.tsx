  ...
  const posts = [
    {
      ...
      views: 84,
      reviews: 0,
      caption: 'Just updated my profile picture! Feeling great and ready for new opportunities. This year is going to be amazing. Grateful for all the support from my friends and family. Let\'s make it count! 🎉✨',
    },
    {
      id: 2,
      ...
      views: 60,
      reviews: 0,
      caption: 'New profile picture! Excited about the journey ahead. This has been an incredible year of growth and learning. I\'m grateful for all the opportunities that have come my way and the amazing people I\'ve met along the way. Looking forward to what the future holds! 🌟',
    },
    {
      id: 3,
      ...
      caption: 'Great day at the conference! Met so many amazing people and learned a lot. The future of technology is bright. Can\'t wait to share what I\'ve learned with the team. Innovation never stops! 🚀',
    },
  ];
      ...
      <header className="newsfeed-header">
        <div className="newsfeed-header__container">
          ...
          <div className="newsfeed-header__actions">
            ...
            <button className="newsfeed-header__icon-btn newsfeed-header__icon-btn--notifications" title="Notifications">
              <Bell size={20} />
            </button>
