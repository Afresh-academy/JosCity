        ...
        <div className="legal-container">
          ...
          <div className="legal-content">
            ...
            <section className="legal-section">
              ...
              <p>
                The guidelines have three levels of conformance (A, AA, and
                AAA). We are working toward Level AA compliance, which includes:
              </p>
              <ul>
            ...
            <section className="legal-section">
              ...
              <p>
                All interactive elements can be accessed using a keyboard. You
                can navigate through the Platform using:
              </p>
              <ul>
                <li>
                ...
                <li>
                  <strong>Escape:</strong> Close modals and menus
                </li>
              </ul>

              <h3>3.2 Screen Reader Support</h3>
              <p>
                Our Platform is designed to work with screen readers and
                assistive technologies. We use semantic HTML, ARIA labels, and
                proper heading structures to ensure content is accessible.
              </p>

              <h3>3.3 Text Alternatives</h3>
              <p>
                We provide alternative text for images and other non-text
                content to ensure information is accessible to users who cannot
                see visual content.
              </p>

              <h3>3.4 Color and Contrast</h3>
              <p>
                We maintain sufficient color contrast ratios to ensure text is
                readable for users with visual impairments. Color is not used as
                the sole means of conveying information.
              </p>

              <h3>3.5 Text Resizing</h3>
              <p>
                Users can resize text up to 200% using browser zoom controls
                without losing functionality or content.
              </p>

              <h3>3.6 Forms and Inputs</h3>
              <p>
                All form fields are properly labeled, and error messages are
                clearly identified and associated with the relevant fields.
              </p>
            </section>
            ...
            <section className="legal-section">
              ...
              <p>
                ...
                some limitations. We are actively working to address these
                issues:
              </p>
              <ul>
                <li>Some third-party content may not be fully accessible</li>
                <li>
                  Older documents may not meet current accessibility standards
                </li>
                <li>
                  Some interactive features may require additional keyboard
                  navigation improvements
                </li>
              </ul>
              <p>
                We welcome your feedback on accessibility issues. Please contact
            ...
            <section className="legal-section">
              ...
              <p>
                Our Platform is compatible with the following assistive
                technologies:
              </p>
              <ul>
            ...
            <section className="legal-section">
              ...
              <p>
                We welcome your feedback on the accessibility of JosCity Smart
                Services. If you encounter accessibility barriers or have
            ...
            <section className="legal-section">
              ...
              <p>
                ...
                our Platform. Our team regularly:
              </p>
              <ul>
                ...
                <li>
                  Updates content and features to meet accessibility standards
                </li>
                <li>
                  Provides training to our development team on accessibility
                  best practices
                </li>
              </ul>
            </section>
            ...
            <section className="legal-section">
              ...
              <p>
                Some content on our Platform may be provided by third parties.
                While we strive to ensure all content is accessible, we cannot
                guarantee the accessibility of third-party content. If you
                encounter accessibility issues with third-party content, please
                contact us, and we will work with the content provider to
                address the issue.
              </p>
            </section>
