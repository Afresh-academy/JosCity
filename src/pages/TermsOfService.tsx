        ...
        <div className="legal-container">
          ...
          <div className="legal-content">
            ...
            <section className="legal-section">
              ...
              <p>
                JosCity Smart Services provides a digital platform for accessing
                municipal services, including but not limited to:
              </p>
              <ul>
            ...
            <section className="legal-section">
              ...
              <p>When making payments through the Platform, you agree to:</p>
              <ul>
                <li>Provide valid payment information</li>
                <li>Authorize charges for services you request</li>
                <li>
                  Understand that all transactions are final unless otherwise
                  stated
                </li>
                <li>Comply with refund and cancellation policies</li>
              </ul>
              <p>
                We reserve the right to refuse or cancel any transaction at our
                discretion.
              </p>
            </section>
            ...
            <section className="legal-section">
              ...
              <p>
                ...
                images, and software, are the property of JosCity Smart Services
            ...
            <section className="legal-section">
              ...
              <p>
                You agree to indemnify and hold harmless JosCity Smart Services,
                its officers, employees, and agents from any claims, damages,
                losses, liabilities, and expenses arising out of your use of the
            ...
            <section className="legal-section">
              ...
              <p>
                ...
                access to the Platform at any time, with or without cause or
            ...
            <section className="legal-section">
              ...
              <p>
                ...
                this page. Your continued use of the Platform after such changes
